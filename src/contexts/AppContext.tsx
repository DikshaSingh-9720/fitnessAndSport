...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const yogaPoses: YogaPose[] = [
    {
      ...
      instructions_hi: ['पैरों को एक साथ रखकर खड़े हों', 'वजन को समान रूप से वितरित करें', 'जांघों को संलग्न करें', 'छाती उठाएं', 'कंधों को आराम दें'],
      duration_minutes: 3,
    ...
    },
    {
      ...
      instructions_hi: ['बाएं पैर पर खड़े हों', 'दाहिना पैर भीतरी जांघ पर रखें', 'हथेलियों को एक साथ लाएं', 'एक बिंदु पर नजर रखें', 'स्थिर रहें'],
      duration_minutes: 4,
      image_url: 'https://images.pexels.com/photos/3822906/pexels-photo-3822906.jpeg'
    },
    {
      ...
      instructions_hi: ['पेट के बल लेटें', 'हथेलियां कंधों के नीचे रखें', 'हाथों में दबाएं', 'छाती को ऊपर उठाएं', 'कंधों को आराम से रखें'],
      duration_minutes: 3,
    ...
    },
    {
      ...
      instructions_hi: ['पैर फैलाकर बैठें', 'सांस लें और रीढ़ को लंबा करें', 'सांस छोड़ें और आगे झुकें', 'पैर या पिंडलियां पकड़ें', 'गहरी सांस लें'],
      duration_minutes: 5,
      image_url: 'https://images.pexels.com/photos/3822621/pexels-photo-3822621.jpeg'
    },
    {
  ...
  const ayurvedaMeals: AyurvedaMeal[] = [
    ...
    },
    {
      ...
      ingredients_hi: ['ओट्स', 'खजूर', 'दूध', 'इलायची', 'बादाम'],
